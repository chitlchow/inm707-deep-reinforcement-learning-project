...
def game_loop(alpha, gamma, epsilon_discount):
    learner = double_DQN_agent(learning_rate=alpha, gamma=gamma, epsilon_decay=epsilon_discount)
        ...
        while not crash or steps_without_food == 100:
            ...
            if snake.get_head_position() == food.position:
                ...
                if score >= high:
                    ...
                    learner.model1.save_model(f_name='model1-snapshot-score-{}.pth'.format(high))
                    learner.model2.save_model(f_name='model2-snapshot-score-{}.pth'.format(high))
                reward = 10
